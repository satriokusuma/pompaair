 ...
 */ !(function (e) {
  ...
  function (e, t, n) {
    ...
    })('versions', []).push({ version: o.version, mode: n(23) ? 'pure' : 'global', copyright: 'Â© 2019 Denis Pushkarev (zloirock.ru)' });
  },
  function (e, t) {
    e.exports = !1;
  },
      ...
      s = function () {
        ...
        (e.initialize = function () {
          ...
          (e.sendExtensionPostMessage = function (e, t) {
            window.postMessage(
              { method: 'postMessagePlatformWidget', data: { settings: t.settings, app_slug: t.app, public_id: t.id, platform: 'eapps' } },
              '*'
            );
          }),
          e.initialize();
  ...
  function (e, t, n) {
    ...
    function r(e, t) {
      var n = b(),
        o = w[w.length - 1];
      if ('top' === e.insertAt)
        o ? (o.nextSibling ? n.insertBefore(t, o.nextSibling) : n.appendChild(t)) : n.insertBefore(t, n.firstChild), w.push(t);
      else {
